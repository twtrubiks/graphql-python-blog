...
> 後端完成後才開始前端開發
>
> 💡 **核心任務**：專注於展示 GraphQL 的 Query、Mutation、Subscription 功能
>
> 📌 **選擇性任務**：標記為刪除線的項目可在時間允許時實作

### 6.1 SvelteKit 專案設置
- [x] 創建 SvelteKit 專案 (Svelte 5)
- [x] 設置 TypeScript
- [x] 配置 Tailwind CSS
- [x] 設置環境變數
- [x] 配置 SSR/CSR 策略
...
- [x] 實作文章詳情頁
- [x] 實作文章編輯器 (Markdown)
- [x] 實作草稿管理頁面 (`/my-drafts`)
- [x] 實作文章快速發布/取消發布功能
- [ ] ~~實作標籤瀏覽頁面~~

### 6.5 用戶相關頁面
- [x] 實作個人資料頁 (`/users/[username]`)
- [x] 實作個人設定頁 (`/settings`)
- [x] 實作追蹤者/追蹤中列表 (`/users/[username]/followers`, `/users/[username]/following`)
- [x] 實作我的文章頁面 (`/my-posts`)
- [ ] ~~實作通知中心~~
- [x] 實作用戶公開頁面 (`/users/[username]`)
...
- **Phase 6**: 1.5 週 (前端開發 - 核心功能為主，選擇性功能可延後)
